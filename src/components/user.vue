    ...
    <div id="user"> 
        ...
        <el-dialog title="创建用户" v-model="dialogCreateVisible" :close-on-click-modal="false" :close-on-press-escape="false" @close="reset" >
            <el-form id="#create" :model="create" :rules="rules" ref="create" label-width="100px">
                ...
                <el-form-item label="学号" prop="studentId">
                    <el-input v-model="create.studentId"></el-input>
                </el-form-item>
                ...
                <el-form-item label="微信" prop="wechatId">
                    <el-input v-model="create.wechatId"></el-input>
                </el-form-item>
                <el-form-item label="宿舍号" prop="roomId">
                    <el-input v-model="create.roomId"></el-input>
                </el-form-item>
        ...
        <el-dialog title="修改用户信息" v-model="dialogUpdateVisible"  :close-on-click-modal="false" :close-on-press-escape="false">
            <el-form id="#update" :model="update" :rules="updateRules" ref="update" label-width="100px">
                ...
                <el-form-item label="微信" prop="wechatId">
                    <el-input v-model="update.wechatId"></el-input>
                </el-form-item>
                <el-form-item label="宿舍号" prop="roomId">
                    <el-input v-model="update.roomId"></el-input>
                </el-form-item>
                <!-- <el-form-item label="是否启用">
        ...
        methods:{
           ...
           // 重置表单
            ...
            setCurrent(user) {
                ...
                this.update.wechatId = user.wechatId;
                this.update.roomId = user.roomId;
